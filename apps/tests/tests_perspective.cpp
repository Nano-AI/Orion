...
//
// The two host-side checks that a mask follows the correction moved to
// tests_mask_geom.cpp on 2026-08-02 (decision #129): they read no GPU and none
// of the fixture below, and `mask::toFrame` on the host is that file.

...
`UNSOURCED.md` §27 rather than implied away.
...
- **§3.3 is built as its model, not as its solve.** The Poisson integration is
  dropped and replaced by a per-pixel clamp; see §5c and `UNSOURCED.md` §27.

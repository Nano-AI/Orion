...
// ── The pyramid, in the same conventions the shaders use ──────────────────
//
// Any expand operator reconstructs exactly so long as analysis and synthesis
// share it; these are the ones llf_down.slang and llf_collapse.slang imply, so
// the reference is comparable to the GPU coefficient by coefficient.

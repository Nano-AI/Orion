...
| 30 | 2026-07-28 | **A control's readout is its own reset**, coloured by whether it has moved | One affordance says which controls are modified *and* what is clickable. A separate change dot in the margin would say it twice, smaller and harder to hit. The base is per photo, not per type: white balance is the camera's reading |

...
## The 2026-09-07 prune — 1,025 lines to 527

`STATUS.md` had grown past the point where "start here" was a thing anyone could
do. Everything below is moved **verbatim** from it, and every block was checked
against `DECISIONS.md` or the tree before it was moved — this is a shortening,
not a deletion. What moved, and why it was safe to move:

- **The pooling and memory saga, ~270 lines** — the audit's #148/#149/#150/#151
  findings, the #152 ceiling, #153's costing, #155's pool, #158/#160's ownership
  change, #161's block, and #162's two costed shapes, the last of which ended
  *"BOTH SHAPES COSTED — AND THIS NOW NEEDS YOUR DECISION."* ⚠ **That decision
  was made and shipped: #219, 2026-09-05**, pooled and lazy, 13,861 → 1,560 MiB
  high-water, 8.9×. The file was still demanding a call that had been made a day
  before, which is the same failure as the queue's.
- **The queue's three items** — all struck through and shipped (#137, #138,
  #112), ~60 lines to say it was empty.
- **The scope block settled by #176** — X-Trans out of scope, the flat frame
  accepted as-is, patent exposure understood and no action wanted.
- ⚠ **"Still blocked on the developer: the licence"** — which read *"a **public
  repo with no LICENSE file**, so default copyright applies"* and offered
  Apache-2.0 or GPL-3.0 as open options. **`LICENSE` has been in the tree since
  2026-08-07**; Apache-2.0 was settled by #43 and #188. `CLAUDE.md` had said so
  for a month. This row was not stale, it was false.
- **"In flight — seventh wave, two agents, 2026-08-02"** — #124 and #125 both
  landed; #125 closed on 2026-08-02. It had said "in flight" for five weeks.
- **The counts block and its story about its own duplicate copies** — replaced in
  `STATUS.md` by numbers measured on 2026-09-07 (1029 / 4113, all seven gates).
  It had carried 806/3708, then 1008/4103, then 1012/4113, none of them current.

Two rows in *Known gaps* stayed in `STATUS.md` and were **re-measured** rather
than moved: the Claude trailer count (the row said 363, it is **446** of 535
commits) and the orphan matte sweep (the row said 26, there are **134**).
